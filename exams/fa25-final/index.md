...
- [Problem 1](#problem-1-10-pts-mt1-redemption)
- [Problem 2](#problem-2-10-pts-mt1-redemption)
- [Problem 3](#problem-3-16-pts-mt1-redemption)
- [Problem 4](#problem-4-8-pts-mt2-redemption)
- [Problem 5](#problem-5-12-pts-mt2-redemption)
- [Problem 6](#problem-6-4-pts-mt2-redemption)
- [Problem 7](#problem-7-6-pts-mt2-redemption)
- [Problem 8](#problem-8-6-pts-mt2-redemption)
...
<ol>
<li markdown="1">
<span class="math-inline">\\(\vec x^{\ast}\\)</span> is
...
<li markdown="1">
because <span class="math-inline">\\(\vec x^{\ast}\\)</span> is the eigenvector of <span class="math-inline">\\(A\\)</span> corresponding to the eigenvalue
